-- Allow driver profiles to reuse the customer domain upsert RPC.
-- Drivers are surfaced inside admin/customers and can hold store/customer data.
...
BEGIN
    ...
    IF v_profile_role NOT IN ('client', 'representative', 'driver') THEN
