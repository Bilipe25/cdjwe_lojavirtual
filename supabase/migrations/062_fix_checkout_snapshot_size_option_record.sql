-- ============================================================
-- Migration 062: Fix checkout_resolve_item_snapshot_v2 record typing
-- Issue:
-- - v_size_option declared as RECORD can stay untyped when item has no size
-- - Accessing v_size_option fields then raises:
--   "record \"v_size_option\" is not assigned yet"
-- ============================================================
