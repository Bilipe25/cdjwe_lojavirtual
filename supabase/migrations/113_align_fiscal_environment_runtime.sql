-- ============================================================
-- Migration 113: Align fiscal environment runtime behavior
-- - reserve_fiscal_document_emission must use the latest env row
-- - emission must respect emissao_ativa
-- ============================================================
...
BEGIN
    ...
    IF COALESCE(v_env.emissao_ativa, FALSE) IS NOT TRUE THEN
        RAISE EXCEPTION 'Emissao fiscal desativada no ambiente.';
    END IF;
