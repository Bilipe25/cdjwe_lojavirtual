-- ============================================================
-- Migration 056: Fix ambiguous route_number in route creation RPC
-- - Qualifies RETURNING columns in admin_create_delivery_route_atomic
--   to avoid collision with OUT parameters in plpgsql.
-- ============================================================
